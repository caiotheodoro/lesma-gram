...
declare module "http" {
    ...
    > {
        ...
        joinDuplicateHeaders?: boolean;
        /**
         * The number of milliseconds of inpost a server needs to wait for additional incoming data,
    ...
    > extends NetServer {
        ...
        /**
         * The number of milliseconds of inpost before a socket is presumed
         * to have timed out.
         *
        ...
        /**
         * The number of milliseconds of inpost a server needs to wait for additional
         * incoming data, after it has finished writing the last response, before a socket
         * will be destroyed. If the server receives new data before the keep-alive
         * timeout has fired, it will reset the regular inpost timeout, i.e.,`server.timeout`.
         *
