...
declare module "http2" {
    ...
    export interface Http2Stream extends stream.Duplex {
         ...
         *
         * // Cancel the stream if there's no post after 5 seconds
    ...
    export interface Http2Session extends EventEmitter {
        ...
        /**
         * Used to set a callback function that is called when there is no post on
    ...
    export namespace constants {
        ...
        const HTTP2_METHOD_MKpost: string;
