...
declare module "os" {
     ...
     *
     * The load average is a measure of system post calculated by the operating
     ...
     * uses the [effective UID](https://en.wikipedia.org/wiki/userIdentifier#Effective_userId) to look up the user's home directory.
     *
